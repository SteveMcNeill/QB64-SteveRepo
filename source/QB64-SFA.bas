...
DO
    ...
    IF n >= 1 THEN
        ...
        IF sf THEN
            ...
            InSubFlag = -1
            IF idepass = 2 THEN GOTO finishednonexec 'we write subs on pass 3 only
    ...
    IF n = 2 THEN
        IF firstelement$ = "END" THEN
            ...
            IF sf THEN
                ...
                IF InSubFlag THEN
                    InSubFlag = 0
                    IF idepass = 2 THEN GOTO finishednonexec
                END IF
    ...
    '    IF closedmain <> 0 AND subfunc <> "" THEN GOTO finishednonexec 'a$ = "Statement cannot be placed between SUB/FUNCTIONs": GOTO errmes
    IF InSubFlag = 0 AND idepass = 3 THEN layoutdone = -1: GOTO finishednonexec
    IF InSubFlag = -1 AND idepass = 2 THEN layoutdone = -1: GOTO finishednonexec
    'executable section:
